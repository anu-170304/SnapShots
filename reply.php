...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="200">
          ...
          <section class="site-section" id="section-reg">
            <div class="container">
              <div class="row justify-content-center">
                <div class="col-md-8">
                  <h2 class="mb-5 heading">Reply To User</h2>
        ...
        <input type="hidden" class="form-control" name="id" id="fname" value='<?php echo "{$rows['id']}"; ?>' aria-describedby="helpId" placeholder="">
                    ...
                    <!-- <div class="row form-group">
                        <div class="col-md-6 mb-3 mb-md-0">
                            ...
                            <input type="text"
            class="form-control" name="name" id="fname" value=' aria-describedby="helpId" placeholder="">
                        </div>
                    </div> -->
                    ...
                    <!-- <div class="row form-group">
                        <div class=" col-md-6 ">
                            ...
                            <input type="password" id="fname" name="pass" value=' class="form-control" />
                        </div>
                    </div>
                 -->
                 <div class="row form-group">
                        <div class="col-md-6">
                            ...
                            <input type="number" id="number" name="number" value='<?php echo"{$rows['contactno']}"?>' class="form-control" />
                        </div>
                    </div>
    ...
    <div class="col-md-6">
        ...
        <!-- Use PHP to echo the content from the database inside the textarea -->
        <textarea name="message" id="message" cols="30" rows="7" class="form-control"><?php echo "{$rows['message']}"; ?></textarea>
    </div>
</div>
                 
      <div class="row form-group">
    <div class="col-md-6">
        <label class="" for="message"> Reply</label>
        <!-- Use PHP to echo the content from the database inside the textarea -->
        <textarea name="reply" id="message" cols="30" rows="7" class="form-control"></textarea>
    </div>
</div>
